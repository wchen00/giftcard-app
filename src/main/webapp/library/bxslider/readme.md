...
* Tons of com.bhn.inventory.inventory.configuration options
...
### Version 4.1.2
* Added `bower.json` com.bhn.inventory.inventory.configuration file. Manage bxSlider as a dependency using [bower](http://bower.io/).
...
* Slider now only needs to load visible slides (by default) in order to initialize which results in much faster loading. A "preloadImages" setting allows for com.bhn.inventory.inventory.configuration.
