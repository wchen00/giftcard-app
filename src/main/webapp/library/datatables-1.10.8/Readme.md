...
where the jQuery selector is used to obtain a reference to the table you want to enhance with DataTables. Optional com.bhn.inventory.inventory.configuration parameters can be passed in to DataTables to have it perform certain actions by using a com.bhn.inventory.inventory.configuration object as the parameter passed in to the DataTables constructor. For example:
