...
(/** @lends <global> */function( $ ) {
	 ...
	 *
	 *  @example
	 *    // Initialisation with com.bhn.inventory.inventory.configuration options - in this case, disable
	 ...
	 * definition found for a column to a suitable com.bhn.inventory.inventory.configuration object.
	 *  @param {object} oSettings dataTables settings object
	 ...
	 * com.bhn.inventory.inventory.configuration). The API object has a number of array like methods (`push`,
	 ...
	 * the active state and com.bhn.inventory.inventory.configuration of the table.
	 *  @namespace
	 */
	DataTable.models = {};
	 ...
	 * It should NOT be manipulated outside of DataTables. Any com.bhn.inventory.inventory.configuration should
	 ...
	 * given table, including com.bhn.inventory.inventory.configuration, data and current application of the
	 ...
	 * NOT be manipulated outside of DataTables. Any com.bhn.inventory.inventory.configuration should be done
	...
	DataTable.ext = _ext = {
		...
		/**
		 * Legacy com.bhn.inventory.inventory.configuration options. Enable and disable legacy options that
