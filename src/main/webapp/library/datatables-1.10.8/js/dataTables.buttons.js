...
var Buttons = function( dt, config )
{
	...
	// For easy com.bhn.inventory.inventory.configuration of buttons an array can be given
	if ( $.isArray( config ) ) {
...
Buttons.prototype = {
	 ...
	 * @param {object} Button com.bhn.inventory.inventory.configuration object, base string name or function
	 * @return {Buttons} Self for chaining
	 */
	 ...
	 * @param {object} Resolved button com.bhn.inventory.inventory.configuration object
	 * @private
	 */
	...
	_buildButtons: function ( buttons, container, collectionCounter )
	{
		...
		for ( var i=0, ien=buttons.length ; i<ien ; i++ ) {
			...
			// If the com.bhn.inventory.inventory.configuration is an array, then expand the buttons at this
			// point
			if ( $.isArray( conf ) ) {
	 ...
	 * @param  {object} config            Resolved button com.bhn.inventory.inventory.configuration
	 ...
	 * button is removed)
	 * @param  {object} Button com.bhn.inventory.inventory.configuration
	 */
	...
	/**
	 * Resolve a button com.bhn.inventory.inventory.configuration
	 * @param  {string|function|object} Button config to resolve
	 * @return {object} Button com.bhn.inventory.inventory.configuration
	 */
	_resolveExtends: function ( conf )
	{
		...
		var toConfObject = function ( base ) {
			...
			// Loop until we have resolved to a button com.bhn.inventory.inventory.configuration, or an
